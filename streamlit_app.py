...
add_my_fruit = streamlit.text_input('What fruit would you like to add?')   # the old code with default value streamlit.text_input('What fruit would you like to add?', 'jackfruit')
